...
- [x] S11-01 — definir contrato e wiring do handler `/team`.
- [x] S11-02 — implementar list/show/budget/run/stream/cancel no agente.
...
- [x] S11-07 — revisar, commitar e abrir PR.
