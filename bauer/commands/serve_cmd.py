...
def serve(
    ...
    fastapi_app = create_app(
        ...
        api_key=serve_key,
        web_auth_enabled=cfg.serve.web_auth_enabled,
        auth_session_hours=cfg.serve.auth_session_hours,
        auth_google_client_id=cfg.serve.auth_google_client_id,
        auth_cookie_secure=cfg.serve.deployment_mode == "reverse_proxy",
