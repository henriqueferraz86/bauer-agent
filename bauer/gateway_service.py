...
class GatewayServiceManager:
    ...
    def status(self) -> ServiceStatus:
        ...
        if self.platform == "unsupported":
            st.detail = "plataforma sem systemd/Task Scheduler"
            return st
        ...
        if pid is not None:
            ...
            # gerenciador diz running mas PID file não confirma — processo
            # pode ter acabado de subir (PID file ainda não escrito)
