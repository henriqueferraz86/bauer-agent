    ...
    *,
    ...
    if tool_mode == "native":
        ...
        tool_protocol_block = (
            ...
            "Use UMA ferramenta quando a pergunta exigir ler/escrever arquivos, listar diretorios,\n"
            "ou consultar informacao atual na internet (clima, noticias, precos, cotacoes,\n"
            "documentacao e fatos recentes). Para informacao atual, prefira `web_search`;\n"
            "para ler uma URL especifica, use `web_fetch`.\n"
            ...
            "  Pergunta: 'qual o clima em Guarulhos?' -> {\"action\": \"web_search\", \"args\": {\"query\": \"clima atual em Guarulhos\"}}\n"
